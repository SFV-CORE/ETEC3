 ...
 * @author 55119
 */
public class jInternatAcoes extends javax.swing.JInternalFrame {

    /**
     * Creates new form jInternatAcoes
     */
    public jInternatAcoes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(JPAcoes, javax.swing.GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE)
        );
    ...
    private void JPAcoesMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JPAcoesMouseMoved
        // TODO add your handling code here:
        if(JPrincipal.level == 1){ //quando consegue a primeira habilidade
            setSize(new Dimension(380, 450));// aumenta o form
        ...
        else if(JPrincipal.level == 2){
            setSize(new Dimension(380, 580));
            dindin -= 150;
            lblNumDin1.setText(String.valueOf(dindin));
            JPrincipal.level = 0;
        }
        else if(JPrincipal.level == 3){
